package com.ashish.gateway.exceptions;
...
import com.ashish.gateway.utility.ResponseHeaderUtility;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GenericResponse> handlerResourceNotFoundException(ServiceUnavailableExection ex1) {
 	    		GenericResponse resp = getResponse("failure", "-1",
 	    				ex1.getMessage(), "Response not found", null);
